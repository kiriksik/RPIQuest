...
from styles import WIN_LIGHT, WIN_BLACK, FONT_NORMAL, FONT_TITLE

from config import LEVEL_MAX, RECOMMENDED_POSITIONS, SCREEN_HEIGHT, SCREEN_WIDTH, STEP_AMOUNT, FINAL_POSITION
import math
